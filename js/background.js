var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/ferrari-laferrari-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/ferrari-laferrari-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/ferrari-laferrari-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/ferrari-laferrari-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Ferrari LaFerrari?",
				description: "Get awesome Ferrari LaFerrari HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
